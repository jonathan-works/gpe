(function() {
        ...
        function $createNamespace(namespace, object) {
                ...
                if (typeof namespace === "string") {
                        ...
                        for(var i=0; i < $path.length; i++) {
                                ...
                                // Aloca uma referкncia ao primeiro objeto na prуpria funзгo $namespace
                                if (i==0) {
                ...
                // Retorna o objeto apontado por namespace caso este jб exista, ou object
                return $_namespace;
        }
        ...
        function $namespace(namespace, object) {
                ...
                // caso seja um array, considera-se que sгo referкncias de importaзгo
                ...
                } else if (typeof namespace === "object" && namespace.constructor === [].constructor) {
