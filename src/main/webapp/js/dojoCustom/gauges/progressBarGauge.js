(function() {
	var $namespace = defineObject(
			"br.com.infox.dojoCustom.gauges.ProgressBarGauge",
			function(args) {
				...
				dojo.ready(function() {
					...
					if (!args.hideTicks) {
						var $ticksLength = $clamp(2, 5, $barHeight * 0.25);
						$props.majorTicks = {
							length : 0.01,
							width : 1,
					...
					var $barColor = args.barColor
							|| $getColor(args.value / $max);
