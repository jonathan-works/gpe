...
public final class StringUtil {
    ...
    private static final String FOREIGN_CHARS = "áÁéÉíÍóÓúÚàÀèÈìÌòÒùÙâÂêÊîÎôÔûÛäÄëËïÏöÖüÜãÃõÕçÇñÑ";
    ...
    public static String piece(String text, String delim, final int p1,
            final int p2) {
        int l1 = p1;
        int l2 = p2;
