...
public class TaskNodeRenderer extends VertexRenderer {
    ...
    private static final Color[] COLORS = new Color[] {
        new Color(0x05, 0x88, 0xc0), new Color(118, 197, 238),
        new Color(0, 145, 64), new Color(131, 194, 41),
        new Color(102, 255, 205), new Color(253, 158, 102),
        new Color(151, 0, 201), Color.ORANGE, Color.MAGENTA, Color.PINK,
