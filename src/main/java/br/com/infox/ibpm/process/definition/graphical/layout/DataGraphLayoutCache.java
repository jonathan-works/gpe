...
/**
 * A Graph Layout Cache that automatically attaches itself as a listener of its
 * associated graph model. The intend usage is for applications that do not
 * create a JGraph instance. Without a JGraph instance there is no UI (in JGraph
 * 5.x) and it is the UI that causes the layout cache to automatically listen to
 * the model.
 */
