...
public interface SituacaoProcessoFilter extends Filter {
	...
	public static final String FILTER_PAPEL_LOCALIZACAO = "papelLocalizacaoSituacaoProcesso";
	public static final String CONDITION_PAPEL_LOCALIZACAO = 
	...
	public static final String FILTER_PARAM_ID_LOCALIZACAO = "idLocalizacao";
