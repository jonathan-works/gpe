    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(br.com.infox.epa.webservice.globalweather.client.GlobalWeather.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = br.com.infox.epa.webservice.globalweather.client.GlobalWeather.class.getResource(".");
