...
public class ProcessoManager extends Manager<ProcessoDAO, Processo> {
    ...
    public void iniciarTask(final Processo processo, final Long idTarefa,
        ...
        if (taskInstanceId != null) {
            ...
            storeUsuario(taskInstanceId, usuarioPerfil.getUsuarioLogin(), usuarioPerfil.getPerfil().getPerfilTemplate().getLocalizacao(), usuarioPerfil.getPerfil().getPerfilTemplate().getPapel());
