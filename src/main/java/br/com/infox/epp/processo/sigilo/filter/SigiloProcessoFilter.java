...
public interface SigiloProcessoFilter {
	...
	/** De acordo com a documentação do Hibernate (https://docs.jboss.org/hibernate/orm/4.2/manual/en-US/html/ch19.html)
	 é melhor que o parâmetro venha do lado esquerdo do operador **/
	...
	String CONDITION_FILTER_SIGILO_PROCESSO = "(not exists (select 1 from tb_sigilo_processo sp where "
			...
			+ "spp.in_ativo = true and :" + PARAM_ID_USUARIO + " = spp.id_usuario_login and "
