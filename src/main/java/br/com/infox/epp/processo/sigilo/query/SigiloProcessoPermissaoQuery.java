...
public interface SigiloProcessoPermissaoQuery {
	...
	String SEQUENCE_NAME = "sq_tb_sigilo_processo_permissao";
	...
	String QUERY_USUARIO_POSSUI_PERMISSAO = "select o from SigiloProcessoPermissao o where o.ativo = true and "
			+ "o.sigiloProcesso = :" + QUERY_PARAM_SIGILO_PROCESSO + " and "
		    + "o.usuario = :" + QUERY_PARAM_USUARIO;
	
	String NAMED_QUERY_INATIVAR_PERMISSOES = "SigiloProcessoPermissao.inativarPermissoes";
	String QUERY_INATIVAR_PERMISSOES = "update SigiloProcessoPermissao o set o.ativo = false where o.sigiloProcesso = :" + QUERY_PARAM_SIGILO_PROCESSO;
	
	String NAMED_QUERY_PERMISSOES_DO_SIGILO = "SigiloProcessoPermissao.permissoesDoSigilo";
	String QUERY_PERMISSOES_DO_SIGILO = "select o from SigiloProcessoPermissao o where o.ativo = true and o.sigiloProcesso = :" + QUERY_PARAM_SIGILO_PROCESSO;
}
