...
public class AnexarDocumentosView implements Serializable {
	...
	private DocumentoUploaderService documentoUploaderService = ComponentUtil
			.getComponent(DocumentoUploaderService.NAME);
	...
	private ClassificacaoDocumentoPapelManager classificacaoDocumentoPapelManager = ComponentUtil
			.getComponent(ClassificacaoDocumentoPapelManager.NAME);
