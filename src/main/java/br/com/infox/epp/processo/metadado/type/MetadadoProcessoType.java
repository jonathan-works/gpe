...
public interface MetadadoProcessoType {
  ...
  String PESSOA_DESTINATARIO = "pessoaDestinatario";
  String ITEM_DO_PROCESSO = "itemProcesso";
  String TIPO_PROCESSO = "tipoProcesso";
  String STATUS_PROCESSO = "statusProcesso";
