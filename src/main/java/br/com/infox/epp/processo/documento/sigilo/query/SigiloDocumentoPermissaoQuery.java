...
public interface SigiloDocumentoPermissaoQuery {
	...
	String QUERY_USUARIO_POSSUI_PERMISSAO = "select o from SigiloDocumentoPermissao o where o.ativo = true and "
			+ "o.sigiloDocumento = :" + QUERY_PARAM_SIGILO_DOCUMENTO + " and "
		    + "o.usuario = :" + QUERY_PARAM_USUARIO;
	
	String NAMED_QUERY_INATIVAR_PERMISSOES = "SigiloDocumentoPermissao.inativarPermissoes";
	String QUERY_INATIVAR_PERMISSOES = "update SigiloDocumentoPermissao o set o.ativo = false where o.sigiloDocumento = :" + QUERY_PARAM_SIGILO_DOCUMENTO;
	
	String NAMED_QUERY_PERMISSOES_DO_SIGILO = "SigiloDocumentoPermissao.permissoesDoSigilo";
	String QUERY_PERMISSOES_DO_SIGILO = "select o from SigiloDocumentoPermissao o where o.ativo = true and o.sigiloDocumento = :" + QUERY_PARAM_SIGILO_DOCUMENTO;
	...
	String QUERY_USUARIO_POSSUI_PERMISSAO_DOCUMENTOS = "select o from SigiloDocumentoPermissao o "
			...
			+ "s.ativo = true and "
			+ "s.documento.idProcessoDocumento in (:" + QUERY_PARAM_IDS_DOCUMENTO + ") and "
		    + "o.usuario = :" + QUERY_PARAM_USUARIO;
	...
	String QUERY_DOCUMENTOS_PERMITIDOS = "select o from ProcessoDocumento o "
	        + "where o.processo = :" + QUERY_PARAM_PROCESSO
	        + " and (not exists (select 1 from SigiloDocumento s where s.ativo = true and s.documento = o) or "
	            + "exists (select 1 from SigiloDocumentoPermissao sp where sp.usuario = :" + QUERY_PARAM_USUARIO
