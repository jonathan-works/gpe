...
public class TransitionsXPDL implements Serializable {
    ...
    private static List<TransitionXPDL> createTransitionList(
            List<Element> list, List<ActivityXPDL> activities) throws IllegalXPDLException {
    ...
    public static TransitionsXPDL createInstance(Element root,
            List<ActivityXPDL> activities) throws IllegalXPDLException {
