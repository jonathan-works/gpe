...
public final class ActivityXPDLFactory {
    ...
    public static ActivityXPDL createInstance(Element element, String name) throws ActivityNotAllowedXPDLException {
        ...
        if (isStartState(element)) {
            ...
            throw new ActivityNotAllowedXPDLException("Tipo de nó não permitido no sistema. Nome do nó: '"
                    + XmlUtil.getAttributeValue(element, "Name") + "'.");
        }
        return activity;
    }
    ...
    /**
     * Método responsável por identificar se o element é um subprocesso
     * (ProcessState)
     * 
     * @param element
     * @return
