...
@AutoCreate
public class TipoModeloDocumentoPapelDAO extends DAO<TipoModeloDocumentoPapel, Integer> {
    ...
    public List<TipoModeloDocumentoPapel> getTiposModeloDocumentoPermitidos() {
        ...
        parameters.put(PAPEL_PARAM, Authenticator.getUsuarioLocalizacaoAtual().getPapel());
