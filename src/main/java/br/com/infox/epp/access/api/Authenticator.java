            ...
            if (pessoaFisica != null) {
            	if (pessoaFisica.getTermoAdesao() != null) {
	                ...
	                for (UsuarioPerfil usuarioPerfil : usuario.getUsuarioPerfilAtivoList()) {
	                    Papel papel = usuarioPerfil.getPerfil().getPerfilTemplate().getPapel();
...
//            getLocalizacoesFilhas(loc.getEstruturaFilho(), list);
    ...
    private void setVariaveisDoContexto(UsuarioPerfil usuarioPerfil,
        ...
        Contexts.getSessionContext().set(INDENTIFICADOR_PAPEL_ATUAL, usuarioPerfil.getPerfil().getPerfilTemplate().getPapel().getIdentificador());
        Contexts.getSessionContext().set(PAPEIS_USUARIO_LOGADO, roleSet);
        Contexts.getSessionContext().set(LOCALIZACOES_FILHAS_ATUAIS, getLocalizacoesFilhas(usuarioPerfil.getPerfil().getPerfilTemplate().getLocalizacao()));
    ...
    private Set<String> getRolesAtuais(UsuarioPerfil usuarioPerfil) {
        return RolesMap.instance().getChildrenRoles(usuarioPerfil.getPerfil().getPerfilTemplate().getPapel().getIdentificador());
    }
    ...
    public static Localizacao getLocalizacaoAtual() {
        ...
        if (usuarioPerfilAtual != null) {
            return usuarioPerfilAtual.getPerfil().getPerfilTemplate().getLocalizacao();
        }
        return null;
    }
    ...
    public static Papel getPapelAtual() {
        UsuarioPerfil usuarioPerfilAtual = getUsuarioPerfilAtual();
        if (usuarioPerfilAtual != null) {
            return usuarioPerfilAtual.getPerfil().getPerfilTemplate().getPapel();
        }
        return null;
    }
