...
public class ProcessoTimerStarter {
    ...
    private static final LogProvider LOG = Logging.getLogProvider(ProcessoTimerStarter.class);
    ...
    public void init() throws SchedulerException, DAOException {
        ...
        if (idIniciarFluxoTimer == null) {
            final String property = QUARTZ_PROPERTIES.getProperty(QuartzConstant.QUARTZ_CRON_EXPRESSION, DEFAULT_CRON_EXPRESSION);
