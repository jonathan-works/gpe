    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(br.com.infox.epp.webservice.globalweather.client.GlobalWeather.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = br.com.infox.epp.webservice.globalweather.client.GlobalWeather.class.getResource(".");
    ...
    public GlobalWeather(URL wsdlLocation) {
        super(wsdlLocation, new QName("http://www.webserviceX.NET", "GlobalWeather"));
    }    
