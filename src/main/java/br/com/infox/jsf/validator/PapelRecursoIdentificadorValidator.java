...
public class PapelRecursoIdentificadorValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component,
        ...
        String mensagem = MessageFormat.format("O {0} {1}deve iniciar com /", isPapel ? "papel" : "recurso", isPapel ? "não " : "");
        if ((isPapel && identificador.startsWith("/"))
                || (!isPapel && !identificador.startsWith("/"))) {
